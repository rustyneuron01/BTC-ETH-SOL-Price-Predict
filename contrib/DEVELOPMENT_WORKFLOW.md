...
This workflow helps keep the project organized and makes contribution easier.
...
The codebase uses two main branches: **main** and **staging**.

**main**
- Live production branch, updated by the core team. Protected; do not push or merge unless authorized.

**staging**
- Continuously updated; propose and merge changes here. Active development branch.
...
This involves releasing stable code and generating a new version for the project.
...
- **CircleCI job**: Create jobs in CircleCI to automate the merging of staging into main and release version (needed to release code) and building and testing the project (needed to merge PRs).
...
Follow these steps when you are contributing to this project:
...
- CircleCI jobs 
    ...
    - Build and Test (needed to merge PRs)

This document can be improved as the project continues to develop and change.
