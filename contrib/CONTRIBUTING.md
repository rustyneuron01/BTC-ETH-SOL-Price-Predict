...
The following is a set of guidelines for contributing to this project. These are **HIGHLY RECOMMENDED** guidelines, but not hard-and-fast rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
> Please follow the project [style guide](./STYLE.md) regardless of your contribution type. 
...
> Review the project [style guide](./STYLE.md) and [development workflow](./DEVELOPMENT_WORKFLOW.md) before contributing. 
...
```bash
git remote add upstream https://github.com/<org>/<repo>.git  # or your fork
git fetch upstream
...
* If the problem started happening recently, **can you reproduce the problem in an older version of the project?** 
...
* **Are you running the application in a Docker container?** If so, have you made sure that your docker container contains your latest changes and is up to date with Master branch?
