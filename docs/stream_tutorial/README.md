...
This document is a developer-friendly walkthrough of integrating streaming into your application.
...
Start your worker (example; use your network and identity flags as required):
```bash
